...
class HorizontalSiteList extends StatelessWidget {
  ...
  Future<List<String?>> _getUserRole() async {
  ...
  Stream<QuerySnapshot> _getSitesStream(String role, String? globalName) {
    switch (role) {
      case 'Admin':
      ...
      case 'Supervisor':
        return FirebaseFirestore.instance
            .collection("sites")
            .where("supervisor", isEqualTo: globalName)
            .orderBy('lastActivity', descending: true)
            .snapshots();
      case 'Engineer':
        return FirebaseFirestore.instance
      ...
      builder: (context, roleSnapshot) {
        ...
        return SizedBox(
          ...
          child: StreamBuilder<QuerySnapshot>(
            stream: _getSitesStream(role[0]!, role[1]),
